      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 w-full">
        <div className="grid items-center gap-6 sm:gap-8 lg:gap-10 lg:grid-cols-[minmax(0,380px),1fr]">
          ...
          <div className="w-full min-w-0">
            ...
            {/* Glass terminal */}
            <div className="mt-6 overflow-hidden rounded-2xl border border-white/20 bg-black/40 backdrop-blur-md shadow-glass max-w-xl">
              {/* Title bar */}
              <div className="flex items-center justify-between border-b border-white/20 px-4 py-2 flex-wrap gap-2">
              ...
              <div className="px-4 py-4 text-sm overflow-x-auto">
                <div className="font-mono text-[13px] text-white break-all">
                  ...
                  {!reduce && <span className="caret text-cyan-400" aria-hidden="true" />}
                </div>
                <p className="mt-3 text-[15px] leading-7 text-white break-words">{BIO}</p>
              </div>

              {/* Token marquee */}
              <div
                className="relative select-none overflow-hidden border-t border-white/20 bg-black/30 py-3"
              ...
              >
                ...
                >
                  {[...TOKENS, ...TOKENS].map((t, i) => (
                    <span key={i} className="rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs text-gray-200">
                      {t}
                    </span>
                  ))}
                </div>
